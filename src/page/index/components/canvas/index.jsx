...
const ChartLine = React.lazy(() => import('./components/echarts/chart-line'))
const ChartBar = React.lazy(() => import('./components/echarts/chart-bar'))
const ChartPie = React.lazy(() => import('./components/echarts/chart-pie'))
